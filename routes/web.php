...
Route::middleware('auth', 'valid.user', 'xss')->group(function () {
    ...
    Route::prefix('admin')->middleware('role:admin', 'multi_tenant')->group(function () {
...
Route::get('{alias}/blog/{id}',
    [VcardController::class, 'showBlog'])->name('vcard.show-blog')->middleware(['vcardSubscription']);
