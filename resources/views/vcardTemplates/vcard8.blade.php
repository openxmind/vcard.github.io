                                    ...
                                    <div class="col-sm-6 col-12">
                                        ...
                                        <div class="event-details">
                                            ...
                                            <h5 class="text-center mb-0 text-white"><a
                                                        href="tel:+{{ $vcard->alternate_region_code }} {{ $vcard->alternative_phone }}"
                                                        class="text-white text-decoration-none">+{{ $vcard->alternate_region_code }} {{ $vcard->alternative_phone }}</a>
                                            </h5>
                                        </div>
                                    </div>
                                @endif
